function [xupd_1, Pupd_1, RMS_1, RMS_1_1, SRNFN_P1, SRNFN_R1] = KFNCM_without_classification(A,Bd,C,Q_cons,R_cons,R_true,Xtrue,Ytrue,Pupd,mc, RMS_1, RMS_1_1, SRNFN_P1, SRNFN_R1)
%KFNCM
%使用固定的方差矩阵
xupd_1(:,1) = zeros(4,1);
...
for k = 2:1501 % A
    ...
    Ppre_1(:,:,k) = A * Pupd_1(:,:,k-1) *A' + Bd*Q_cons(:,k-1)*Bd'; % 后面两段的标称值全部按照第一段的
