...
h = legend('KFNCM','RSAKF','VBAKF-R','The proposed filter','Location','southeast');       % 图例
...
line([501 501],[0 lim],'linestyle','--','Color','k');
line([1001 1001],[0 lim],'linestyle','--','Color','k');
text(200-10,0.9*lim,'ISO-E','FontSize',6.5);
text(700-10,0.9*lim,'ISO-C','FontSize',6.5);
text(1200-10,0.9*lim,'ISO-A','FontSize',6.5);

h = legend('KFNCM','RSAKF','VBAKF-R','The proposed filter','Location','east');       % 图例
set(h,'fontsize',fontsize_legend);
set(gca,'linewidth',linewidth_gca,'fontsize',fontsize_gca)
set(gca,'GridLineStyle','--');
...
fileout = 'SRNFN_without.'; % 输出图片的文件名
