...
Stretch2 = temp(502:1001);
Stretch3 = temp(1002:1501);
ARMSE_41_1 = mean(Stretch1) .^ 0.5; 
ARMSE_41_2 = mean(Stretch2) .^ 0.5; 
ARMSE_41_3 = mean(Stretch3) .^ 0.5;
temp = mean(RMS_41_1, 3);
Stretch1 = temp(2:501);
Stretch2 = temp(502:1001);
Stretch3 = temp(1002:1501);
ARMSE_41_1_1 = mean(Stretch1) .^ 0.5;
ARMSE_41_1_2 = mean(Stretch2) .^ 0.5;
ARMSE_41_1_3 = mean(Stretch3) .^ 0.5;
...
% plot( RMSE_4,'linewidth',linewidth_line)
...
% plot( RMSE_4_1,'linewidth',linewidth_line)
