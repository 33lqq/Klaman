...
for mc= 1:mcTime
    ...
    %% 真实Q，R
    [xupd, Pupd, RMS, RMS1] = KFTCM(A,Bd,C,Q_true,R_true,Xtrue,Ytrue,N,mc, RMS, RMS1);
    %% 固定Q，R
    [xupd_1, Pupd_1, RMS_1, RMS_1_1, SRNFN_P1, SRNFN_R1] = KFNCM(A,Bd,C,Q_cons,R_cons,R_true,Xtrue,Ytrue,Pupd,N,mc, RMS_1, RMS_1_1, SRNFN_P1, SRNFN_R1);
    %% 方差匹配
    [xupd_2, Pupd_2, R_hat2, RMS_2, RMS_2_1, SRNFN_P2, SRNFN_R2] = RSAKF(A,Bd,C,Q_cons,R_cons,R_true,Xtrue,Ytrue,Pupd,N,mc, RMS_2, RMS_2_1, SRNFN_P2, SRNFN_R2);
    %% VB-AKF-R
    [xupd_3, Pupd_3, R_hat3, RMS_3, RMS_3_1, SRNFN_P3, SRNFN_R3] = VBAKF_R(A,Bd,C,Q,R,Q_cons,R_cons,R_true,Xtrue,Ytrue,Pupd,N,mc,  RMS_3, RMS_3_1, SRNFN_P3, SRNFN_R3);
    %% 变分贝叶斯
    [xupd_4, Pupd_4, R_hat4, R_hat41, RMS_4, RMS_4_1, RMS_41, RMS_41_1, SRNFN_P4, SRNFN_P41, SRNFN_R4,SRNFN_R41] = ...
        My_filter(A,Bd,C,Q,R,Q_cons,R_cons,R_true,Xtrue,Ytrue,Pupd,N,mc, RMS_4, RMS_4_1, RMS_41, RMS_41_1, SRNFN_P4, SRNFN_P41, SRNFN_R4,SRNFN_R41);
end
