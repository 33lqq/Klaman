function [xupd_2, Pupd_2, R_hat2, RMS_2, RMS_2_1, SRNFN_P2, SRNFN_R2] = RSAKF(A,Bd,C,Q_cons,R_cons,R_true,Xtrue,Ytrue,Pupd,N,mc, RMS_2, RMS_2_1, SRNFN_P2, SRNFN_R2)
m=20;
xupd_2(:,1) = zeros(4,1);
Pupd_2(:,:,1) = zeros(4);%eye(4);%zeros(4); %对称就行
for i=1:m
    R_hat_2(:,:,i) = diag( R_cons(:,i) );
    R_hat2(:,i) = R_cons(:,i);
end
%% Stretch 1, A
for k = 2:N % A
