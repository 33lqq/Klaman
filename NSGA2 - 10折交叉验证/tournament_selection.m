function f = tournament_selection(chromosome, pool_size, tour_size) %二元锦标赛选择算子，比较的只有两个个体
[pop, variables] = size(chromosome); %获得种群的个体数量和决策变量数量,variables =2150
rank = variables - 1; %个体向量中排序值(等级)所在位置
